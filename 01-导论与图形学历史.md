...
- Levoy, Gortler: **Light Field / Lumigraph**
...
- AI 加速降噪器 (SIGGRAPH 2017) → NVIDIA DLSS
...
| **Mesh Shader** | 2018+ | 替代传统 IA/VS/GS，更灵活的几何管线 | NVIDIA Turing+, Vulkan Mesh Shader |
...
### AI 对渲染的影响
- **DLSS / FSR / XeSS**：AI 超分辨率，低分辨率渲染 → 高分辨率输出
- **AI 降噪**：减少蒙特卡洛路径追踪所需的采样数
- **NeRF / 3D Gaussian Splatting**：用神经网络隐式表示场景
